...
const cards = [
  {
    ...
    what: "Early-years cognitive assessment that helps understand how young learners observe, explore, connect ideas and solve simple problems.",
  ...
  },
  {
    ...
    what: "International assessments that evaluate conceptual understanding, reasoning, problem-solving and knowledge application.",
